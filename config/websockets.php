...
return [
    ...
    */
    ...
    'dashboard' => [
        ...
        'domain' => env('LARAVEL_WEBSOCKETS_DOMAIN', '127.0.0.1'),
    ...
    */
    ...
    'apps' => [
        [
            ...
            'allowed_origins' => [
                'http://127.0.0.1:8000',  // Allow all origins or restrict as needed
            ],
        ],
    ],
    ...
    */
    ...
    'ssl' => [
        'local_cert' => env('LARAVEL_WEBSOCKETS_SSL_LOCAL_CERT', null),  // Path to your SSL certificate
        'capath' => env('LARAVEL_WEBSOCKETS_SSL_CA', null),  // Path to CA bundle
        'local_pk' => env('LARAVEL_WEBSOCKETS_SSL_LOCAL_PK', null),  // Path to private key
        'passphrase' => env('LARAVEL_WEBSOCKETS_SSL_PASSPHRASE', null),  // If any passphrase required
        'verify_peer' => env('APP_ENV') === 'production',  // Only in production
        'allow_self_signed' => env('APP_ENV') !== 'production',  // Allow self-signed in non-production
    ],
    ...
    */
    ...
    'logger' => [
        'channel' => 'websockets', // Log WebSocket events to this channel
        'level' => 'debug',
    ],
